...
@RestController
@RequestMapping("/api/retenu-kafka")
public class RetenuKafkaResource {
    private final Logger log = LoggerFactory.getLogger(RetenuKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public RetenuKafkaResource(KafkaProperties kafkaProperties) {
